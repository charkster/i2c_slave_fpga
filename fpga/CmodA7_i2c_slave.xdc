...
create_clock -add -name sys_clk_pin -period 8.33 -waveform {0 4.66} [get_ports { clk }];
...
set_property -dict { PACKAGE_PIN L3    IOSTANDARD LVCMOS33 } [get_ports { sda }]; #IO_L8P_T1_AD14P_35 Sch=pio[02]
set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS33 } [get_ports { scl }]; #IO_L12P_T1_MRCC_16 Sch=pio[03]
